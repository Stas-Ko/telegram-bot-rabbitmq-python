#Файл external_api.py содержит код для выполнения запросов к внешнему API.
#Он использует библиотеку requests для отправки HTTP-запросов и получения ответов.
